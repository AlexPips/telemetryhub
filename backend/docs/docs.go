                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/mqtt.BrokerStats"
                            }
                        }
                    }
                }
        ...
        "/devices/{id}/renames/{field}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Raw field name",
                        "name": "field",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Updated rename configuration",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
